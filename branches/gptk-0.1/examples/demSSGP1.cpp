...
int main()
{
  ...
  cout.precision(4);
	...
	SequentialGP ssgp(2, 1, 40, X, y, gCmp);
	...
	cout << "MEAN: " << mean(meanP) << endl;
	cout << "MIN : " << min(meanP) << endl;
	cout << "MAX : " << max(meanP) << endl;
	cout << "VAR : " << mean(varP) << endl;	
	cout << "MIN : " << min(varP) << endl;
	cout << "MAX : " << max(varP) << endl;
